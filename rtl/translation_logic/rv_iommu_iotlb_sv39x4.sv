...
module rv_iommu_iotlb_sv39x4 #(
    ...
    struct packed {
        ...
        logic [rv_iommu::GPPN2:0]  vpn2;       // 3-level VPN (VPN[2] is the segment expanded by two bits in Sv39x4)
        logic [8:0]             vpn1;
        logic [8:0]             vpn0;
    ...
    always_comb begin : lookup
        automatic logic [rv_iommu::GPPN2:0] mask_pn2;
        mask_pn2 = en_1S_i ? ((2**(rv_iommu::VPN2+1))-1) : ((2**(rv_iommu::GPPN2+1))-1);  // 2^9 - 1 : 2^11 - 1 
        vpn0 = lu_iova_i[20:12];
        vpn1 = lu_iova_i[29:21];
        vpn2 = lu_iova_i[30+rv_iommu::GPPN2:30] & mask_pn2;   // input vaddr[40:30] (Sv39x4), clear additional bits
    ...
    */
    ...
    always_comb begin : update_flush
        ...
        for (int unsigned i = 0; i < IOTLB_ENTRIES; i++) begin
            ...
            vaddr_vpn2_match[i] = (flush_vpn_i[18+rv_iommu::VPN2:18] == tags_q[i].vpn2[rv_iommu::VPN2:0]);   // [26:18]
            ...
            gpaddr_gppn2_match[i] = (flush_vpn_i[18+rv_iommu::GPPN2:18] == gppn[i][18+rv_iommu::GPPN2:18]);
            ...
            */
            ...
            // normal replacement
                ...
                tags_n[i] = '{
                    pscid:      up_pscid_i,
                    gscid:      up_gscid_i,
                    vpn2:       up_vpn_i[18+rv_iommu::GPPN2:18],
                    vpn1:       up_vpn_i[17:9],
                    vpn0:       up_vpn_i[8:0],
                    en_1S:      en_1S_i,
                    en_2S:      en_2S_i,
