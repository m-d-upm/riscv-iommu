...
module rv_iommu_ptw_sv39x4_pc #(
    ...
    // IOTLB tags
    input  logic [rv_iommu::VLEN-1:0]  req_iova_i,
    ...
    logic [rv_iommu::VLEN-1:0] iova_q,   iova_n;
    ...
    generate
        ...
        if (MSITrans != rv_iommu::MSI_DISABLED) begin : gen_msi_support
            ...
            // Bus to send first-stage data to MSI PTW                            
            assign msi_vpn_o        = iova_q[rv_iommu::SVX-1:12];
    ...
    always_comb begin : iotlb_update
        ...
        up_vpn_o = iova_q[rv_iommu::SVX-1:12];
    ...
    assign bad_gpaddr_o = ptw_error_2S_o ? ((ptw_stage_q == STAGE_2_INTERMED) ? gpa_x_q[rv_iommu::GPLEN-1:0] : gpaddr_q) : '0;
            ...
            IDLE: begin
                ...
                if ((init_ptw_i && !edge_trigger_q) || cdw_implicit_access_i) begin
                    ...
                    case ({en_1S_i, en_2S_i})
                        ...
                        2'b01: begin
                            ...
                            if (!cdw_implicit_access_i) begin
                                gpaddr_n = req_iova_i[rv_iommu::SVX-1:0];
                                ptw_pptr_n = {iohgatp_ppn_i[rv_iommu::PPNW-1:2], req_iova_i[rv_iommu::SVX-1:30], 3'b0};
                            end
                        ...
                        2'b10: begin
                            ...
                            // pptr for S1-L1
                            ptw_pptr_n  = {iosatp_ppn_i, req_iova_i[rv_iommu::SV-1:30], 3'b0};
                        end
                        ...
                        2'b11: begin
                            ...
                            pptr[rv_iommu::GPLEN-1:0] = {iosatp_ppn_i[rv_iommu::GPPNW-1:0], req_iova_i[rv_iommu::SV-1:30], 3'b0};
                            gpa_x_n = pptr[rv_iommu::GPLEN-1:0];

                            // pptr for first S2-L1
                            ptw_pptr_n = {iohgatp_ppn_i[rv_iommu::PPNW-1:2], pptr[rv_iommu::SVX-1:30], 3'b0};
                        end
                    ...
                    iova_n = (cdw_implicit_access_i                                ) ? 
                             ({{rv_iommu::VLEN-rv_iommu::GPLEN{1'b0}}, pdt_gppn_i, 12'b0}) : 
                             (req_iova_i                                           );
                            ...
                            case (ptw_stage_q)
                                ...
                                STAGE_1: begin
                                    ...
                                    if (en_2S_i) begin
                                        ...
                                        ptw_pptr_n = {iohgatp_ppn_i[rv_iommu::PPNW-1:2], final_gpa[rv_iommu::SVX-1:30], 3'b0};
                                        main_lvl_n = LVL1;
                                    end
