...
module rv_iommu_sw_if_wrapper #(
    ...
    input  logic [rv_iommu::VLEN-1:0]          iova_i,             // IOVA associated with the request
    ...
    input  logic [rv_iommu::SVX-1:0]               bad_gpaddr_i,   // to report bits [63:2] of the GPA in case of a Guest Page Fault
